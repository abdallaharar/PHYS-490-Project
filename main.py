...
def main():
    ...
    for j in range(10):
        ...
        for i in range(100):
            ...
            out, mu, sigma, latent_out = model(newx, q[i], 1)
            out = out.cpu()
        ...
        # print(latent_out_list)

        # print(len(latent_out_list))

        # print(latent_out_list)

        plt.clf
        plt.cla
        plt.title("Latent Out")
        plt.plot([i for i in range(100)], latent_out_1, color = 'blue')
        plt.plot([i for i in range(100)], latent_out_2, color = 'red')
        plt.plot([i for i in range(100)], latent_out_3, color = 'green')
        # plt.plot(latent_out_list, Gamma_list, color = 'blue')
        # plt.plot(latent_out_list, Velocity_list, color = 'green')
        plt.show()
